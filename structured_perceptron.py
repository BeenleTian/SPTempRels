...
class StructuredPerceptron:
	...
	def __init__(self, labels, dims, averaged=False, loss_augmented_training=False, balance=False, structured_feature_handler=None, regularization=False, regularization_term=1.0):
